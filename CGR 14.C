...
int main() {
	int gd = DETECT, gm, xmin, ymin, xmax, ymax, n, i,result;
	printf("Enter the co-ordinates of top left corner of the clipping window: ");
	scanf("%d %d", &xmin, &ymin);
	printf("Enter the co-ordinates of bottom right corner of the clipping window: ");
	scanf("%d %d", &xmax, &ymax);
